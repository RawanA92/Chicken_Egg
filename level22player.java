...
public class level22player extends AnimListener_egg {
    ...
    public void display(GLAutoDrawable gld) {
        ...
        if (lives != 0) {
            if(score1!=10 && score2!=10) {
                ...
                if (score1 < 0) {
                    lives--;
                    score1 = 0; // Reset the score to prevent continuous decrement
                }

                if (score2 < 0) {
                    lives--;
                    score2 = 0; // Reset the score to prevent continuous decrement
                }
                ...
                textRenderer.draw("Score Box 1: " + score1, 10, 30); // Adjust the coordinates as needed
